 ...
 **********************************************************************/
  ...
  #define __MPCC_H__
    ...
    int pcc_matrix(int m, int n, int p, DataType* A, DataType* B, DataType* P, int nthreads);
    int pcc_vector(int m, int n, int p, DataType* A, DataType* B, DataType* P, int nthreads);
    int pcc_naive( int m, int n, int p, DataType* A, DataType* B, DataType* P, int nthreads);
