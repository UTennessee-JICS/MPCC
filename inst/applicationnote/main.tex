...
1844. However, as Stigler's Law \cite{Stigler1980} dictates the methods name is 
...
PCC computation allow for reduced computational and hardware costs, and improved 
...
(genotypes) shows an 90 fold reduction in computational time compared to 
