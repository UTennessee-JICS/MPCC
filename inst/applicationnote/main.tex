...
\abstract{ \textbf{Motivation:} With the rapidly
  ...
  bottleneck. Especially computating correlations on incomplete data
  are slow.  Here we present a novel high performance and robust
  matrix-based Pearson correlation coefficent (MPCC) algorithm that
  handles missing data and makes effective use of modern CPU Advanced
  Vector Extensions (AVX) extensions. \\
